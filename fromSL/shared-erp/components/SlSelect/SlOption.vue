<template>
    <li class="select-dropdown-item" :class="{'active': selectValues.includes(item[value]),
                    'disabled': computedDisabled}" @click="itemClick(item)">
        <span>{{item[label]}}</span>
        <span v-if="showRight" style="float:right; margin-right:20px; color: #8492a6; ">{{item[rightItem]}}</span>
    </li>
</template>
